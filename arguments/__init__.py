...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.add_language_feature_dist = False
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.start_ins_feat_iter = 10_000
        self.start_root_cb_iter = 20_000 
        self.root_node_num = 64             
        self.leaf_node_num = 5            
        self.leaf_update_fr = 300         
        ...
        self.center_offsets_lr = 0.01
        self.cov_diag_lr = 0.005
        self.cov_off_diag_lr = 0.005
        ...
        self.mlp_language_feature_lr_init = 0.008
        self.mlp_language_feature_lr_final = 0.00005
        self.mlp_language_feature_lr_delay_mult = 0.01
        self.mlp_language_feature_lr_max_steps = 5_000
